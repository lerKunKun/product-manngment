"""Tests for MenuPullService orchestration (CAS-backed, AS2)."""
...
def test_dry_run_returns_one_menu():
    ...
    # 1 menu CAS PUT + 1 manifest = 2 put_object calls
...
def test_real_path_uses_get_menus():
    ...
    assert paths == ["footer.json", "main-menu.json"]
